...
1. Download the source code for project `cap-nodejs`
2. Build the project by staying in the directory `cap-nodejs` on command line
    ```    
    npm install
    npm run build
    ```
3. Deploy the project:
    ```
    npm run approuter-sample2-deploy
    ```
